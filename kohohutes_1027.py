...
def load_hutopanelek(conn):
        ...
        # 1. Definiáljuk a panel sorszámát és a hozzá tartozó ValueY oszlopindexet a CSV-ben.
        # A Panel 7 (index 12 és 13) hiányzik, ezért az oszlopindexek 10-nél eltolódnak.
        # Indexek: (Panel_szam: ValueY_index)
        panel_oszlopok = {
            1: 1, 2: 3, 3: 5, 4: 7, 5: 9, 6: 11,
            # A 7-es kihagyása miatt:
            ...
            with open(HUTOPANELEK_FILE, 'r', encoding='utf-8') as f:
                ...
                for row in csv_reader:
                    for panel_szam, value_index in panel_oszlopok.items():
                        ...
                        # 🚨 KRITIKUS JAVÍTÁS: Tizedesvessző cseréje tizedespontra
                        hofok = hofok_szoveg.replace(',', '.')

                        # Megkérdőjelezhető adatok (pl. üres string) kihagyása
